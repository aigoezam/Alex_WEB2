...
const translations = {
  en: {
    ...
    hero: {
      ...
      hi: "Hi, I'm",
      lead: "Industrial Electronics and Automation Engineer (UPV) with robotics and digital control experience built during a year at the Technical University of Denmark (DTU). Focused on technical problems end to end, from theoretical development and simulation through to implementation in industrial environments.",
    ...
    about: {
      tag: "Who I am",
      title: "About Me",
      p1: "I'm <strong>Alexander Immanuel Goerke</strong>, an <strong>Industrial Electronics and Automation Engineer</strong> from Universitat Politècnica de València (UPV), with a year specializing in robotics and digital control at the <strong>Technical University of Denmark (DTU)</strong>. I'm driven by investigating technical problems end to end, from theoretical development and simulation through to implementation in industrial environments and continuous process improvement.",
      p2: "My Bachelor's thesis focused on the geometric and software design of a delta robot for an agricultural project, covering everything from the kinematics to a C++ controller running on a Teensy 4.1. The prototype is still in use today within a PhD research project at DTU.",
    ...
    journey: {
      ...
      dtu_desc: "Full academic year at DTU focused on Robotics, Digital Control and Deep Learning, working on complex engineering projects alongside international teams.",
      ...
      now: "Now",
      now_title: "Looking for the next challenge",
      now_desc: "Back in Spain, looking for my next challenge in robotics, control and process automation within the tech industry.",
    },
    experience: {
      tag: "Work",
      title: "Experience",
      ...
      cebreo_desc: "Developed tools to visualize biomedical signals (EEG, PPG, accelerometry) across EDF, CSV and .mat data formats, enabling people without a technical background to study human body signals for medical device development. Worked alongside a multidisciplinary team spanning software engineering, physiology and product.",
  ...
  es: {
    ...
    hero: {
      ...
      hi: "Hola, soy",
      lead: "Ingeniero en Electrónica Industrial y Automática (UPV) con experiencia en robótica y control digital forjada durante un año en la Universidad Técnica de Dinamarca (DTU). Centrado en problemas técnicos de principio a fin, desde el desarrollo teórico y la simulación hasta la implementación en entornos industriales.",
    ...
    about: {
      tag: "Quién soy",
      title: "Sobre mí",
      p1: "Soy <strong>Alexander Immanuel Goerke</strong>, <strong>Ingeniero en Electrónica Industrial y Automática</strong> por la Universitat Politècnica de València (UPV), con un año de especialización en robótica y control digital en la <strong>Universidad Técnica de Dinamarca (DTU)</strong>. Me apasiona investigar problemas técnicos de principio a fin, desde el desarrollo teórico y la simulación hasta su implementación en entornos industriales y la mejora continua de los procesos.",
      p2: "Mi Trabajo de Fin de Grado se centró en el diseño geométrico y de software de un robot delta para un proyecto agrícola, abarcando desde la cinemática hasta un controlador en C++ ejecutándose en un Teensy 4.1. El prototipo sigue hoy en uso dentro de un proyecto de doctorado en la DTU.",
    ...
    journey: {
      ...
      dtu_desc: "Año académico completo en la DTU centrado en Robótica, Control Digital y Deep Learning, trabajando en proyectos de ingeniería complejos junto a equipos internacionales.",
      "2025b": "Feb 2026 – Jun 2026",
      ...
      now: "Ahora",
      now_title: "En busca del siguiente reto",
      now_desc: "De vuelta en España, buscando mi próximo reto en robótica, control y automatización de procesos en la industria tecnológica.",
    },
    experience: {
      tag: "Trabajo",
      title: "Experiencia",
      ...
      cebreo_title: "Cebreo Medical A/S: Software Engineer",
      cebreo_desc: "Desarrollé herramientas para visualizar señales biomédicas (EEG, PPG, acelerometría) en formatos EDF, CSV y .mat, permitiendo a personas sin conocimientos técnicos estudiar señales del cuerpo humano para el desarrollo de equipos médicos. Trabajé junto a un equipo multidisciplinar de ingeniería de software, fisiología y producto.",
