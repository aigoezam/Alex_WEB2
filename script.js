...
const translations = {
  en: {
    ...
    hero: {
      ...
      hi: "Hi, I'm",
      lead: "Industrial Electronics and Automation Engineer, recently back from an Erasmus+ exchange at the Technical University of Denmark (DTU). I'm hands-on, curious, and driven to keep learning, and I like taking an idea all the way from code to a machine that actually works on the bench.",
    ...
    about: {
      ...
      p3: "What drives me is curiosity and work ethic: I like picking up new tools fast, digging into how things work under the hood, and putting in the hours a project actually needs, whether that's in the lab, in the code, or on a call with a team.",
    },
    journey: {
      tag: "The path so far",
      title: "My Journey",
      ...
      tfg_desc: "Designed, simulated and built the control system for a differential robotic arm for agricultural weed-intervention, from the math to a working prototype with 1-2 mm end-effector positioning accuracy on real hardware.",
      "2026": "Jan 2026 – Jun 2026",
      cebreo_title: "Cebreo Medical A/S, Copenhagen, Denmark",
      cebreo_desc: "Student worker building EEG, accelerometer and PPG signal-analysis tools for clinical biosignal inspection in a medtech R&D team.",
      now: "Now",
      now_title: "Degree finished, thesis defended",
      now_desc: "Back from Copenhagen with my degree finished, my thesis defended, and real engineering experience under my belt. Hungry to keep learning and ready for the next challenge.",
    },
    experience: {
      tag: "Work",
      title: "Experience",
      ...
      cebreo_desc: "Built EEG signal viewers with filtering, accelerometer motion visualizations, and PPG pulse-analysis tools to support clinical biosignal inspection across EDF, CSV and .mat data formats. Developed synthetic test-signal pipelines for algorithm validation and QA, working inside a multidisciplinary team of software engineers, physiologists and product developers.",
  ...
  es: {
    ...
    hero: {
      ...
      hi: "Hola, soy",
      lead: "Ingeniero en Electrónica Industrial y Automática, recién vuelto de un Erasmus+ en la Universidad Técnica de Dinamarca (DTU). Soy práctico, curioso y con ganas constantes de aprender, y me gusta llevar una idea desde el código hasta una máquina que funciona de verdad en el banco de pruebas.",
    ...
    about: {
      ...
      p3: "Lo que me mueve es la curiosidad y las ganas de trabajar: aprendo herramientas nuevas rápido, disfruto entender cómo funcionan las cosas por dentro y le dedico las horas que un proyecto necesita de verdad, ya sea en el laboratorio, en el código, o en una reunión de equipo.",
    },
    journey: {
      ...
      tfg_desc: "Diseñé, simulé y construí el sistema de control de un brazo robótico diferencial para intervención agrícola contra malas hierbas, desde las matemáticas hasta un prototipo con una precisión de 1-2 mm en el efector final sobre hardware real.",
      "2026": "Ene 2026 – Jun 2026",
      cebreo_title: "Cebreo Medical A/S, Copenhague, Dinamarca",
      cebreo_desc: "Colaborador técnico construyendo herramientas de análisis de señal de EEG, acelerómetro y PPG para inspección de bioseñales clínicas en un equipo de I+D de tecnología médica.",
      now: "Ahora",
      now_title: "Carrera terminada, TFG defendido",
      now_desc: "De vuelta de Copenhague con la carrera terminada, el TFG defendido y experiencia real de ingeniería. Con ganas de seguir aprendiendo y listo para el siguiente reto.",
    },
    experience: {
      tag: "Trabajo",
      title: "Experiencia",
      ...
      cebreo_desc: "Construí visores de señal EEG con filtrado, visualizaciones de movimiento por acelerómetro, y herramientas de análisis de pulso PPG para la inspección de bioseñales clínicas en formatos EDF, CSV y .mat. Desarrollé pipelines de señales sintéticas para validación de algoritmos y QA, dentro de un equipo multidisciplinar de ingenieros de software, fisiólogos y desarrolladores de producto.",
