...
const translations = {
  en: {
    ...
    about: {
      ...
      p4: "I work with Python, C/C++, MATLAB/Simulink and design tools such as SolidWorks. I recently joined Siemens Mobility in Valencia as a Control Centers Engineer, working on control center systems for international rail signaling projects.",
    },
    journey: {
      tag: "The path so far",
      title: "My Journey",
      ...
      "2026b": "Sep 2026 – Present",
      siemens_title: "Siemens Mobility, Valencia, Spain",
      siemens_desc: "Control Centers Engineer in the Control Center Systems team, within the group delivering international rail signaling projects.",
    },
    experience: {
      tag: "Work",
      title: "Experience",
      siemens_period: "Sep 2026 – Present",
      siemens_title: "Siemens Mobility: Control Centers Engineer",
      siemens_desc: "Joined the Control Center Systems team at Siemens Mobility in Valencia, within the group delivering international rail signaling projects. Working on the control center systems used to supervise and operate rail networks, currently in an early stage focused on learning the platform, the tools and the team's engineering workflow.",
      cebreo_period: "Jan 2026 – Jul 2026",
      ...
      tutor_period: "2022 – Jul 2026",
      tutor_title: "Private Tutor: Maths, Physics & Chemistry",
      tutor_desc: "Provided one-to-one academic tutoring for secondary-school students from 2022 to 2026. Planned and developed personalized study plans for each student, structuring the explanation of complex topics clearly and progressively. Recommended by school teachers for strong academic results.",
      leroy_period: "2023",
    ...
    projects: {
      ...
      p1_desc: "Developed the full vision-to-motion pipeline for a 4-DOF robotic arm: HSV-based object detection, camera calibration, pixel-to-world coordinate transformation, inverse kinematics, and smooth joint-space control on Dynamixel servos.",
  ...
  es: {
    ...
    about: {
      ...
      p4: "Trabajo con Python, C/C++, MATLAB/Simulink y herramientas de diseño como SolidWorks. Me he incorporado recientemente a Siemens Mobility en Valencia como Control Centers Engineer, trabajando en sistemas de centro de control para proyectos internacionales de señalización ferroviaria.",
    },
    journey: {
      ...
      "2026b": "Sep 2026 – Presente",
      siemens_title: "Siemens Mobility, Valencia, España",
      siemens_desc: "Control Centers Engineer en el equipo de Control Center Systems, dentro del grupo que desarrolla proyectos internacionales de señalización ferroviaria.",
    },
    experience: {
      tag: "Trabajo",
      title: "Experiencia",
      siemens_period: "Sep 2026 – Presente",
      siemens_title: "Siemens Mobility: Control Centers Engineer",
      siemens_desc: "Incorporación al equipo de Control Center Systems de Siemens Mobility en Valencia, dentro del grupo que desarrolla proyectos internacionales de señalización ferroviaria. Trabajo en los sistemas de centro de control que supervisan y operan redes ferroviarias, actualmente en una primera etapa centrada en aprender la plataforma, las herramientas y el flujo de trabajo del equipo.",
      cebreo_period: "Ene 2026 – Jul 2026",
      cebreo_title: "Cebreo Medical A/S: Software Engineer",
      ...
      tutor_desc: "Ofrecí asesoría académica uno a uno a estudiantes de secundaria desde 2022 hasta 2026. Planifiqué y desarrollé planes de estudio personalizados para cada alumno, estructurando la explicación de conceptos complejos de forma clara y progresiva. Recomendado por el profesorado del centro por los resultados académicos obtenidos.",
      leroy_period: "2023",
    ...
    projects: {
      ...
      p1_desc: "Desarrollé todo el pipeline de visión y control de un brazo robótico de 4 GDL: detección de objetos por segmentación HSV, calibración de cámara, transformación de coordenadas de píxeles a espacio real, cinemática inversa y control suave en el espacio articular sobre servos Dynamixel.",
